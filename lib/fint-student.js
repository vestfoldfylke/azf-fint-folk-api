...
const { skoleElementIsAktiv, repackNavn, repackSkolear, repackTermin, repackAdresselinje, repackSkole, repackMiniSkole, getAge, repackPeriode } = require('./helpers/repack-fint')
...
const repackStudent = (fintStudent) => {
  ...
  for (const forhold of fintStudent.elev.elevforhold) {
    const elevforhold = {
      ...
      gyldighetsperiode: repackPeriode(forhold.gyldighetsperiode),
    ...
    for (const medlemskap of forhold.programomrademedlemskap) {
      ...
      elevforhold.programomrademedlemskap.push({
        ...
        aktiv: medlemskapgyldighetsperiode?.aktiv || false,
        navn: omrade.navn,
    ...
    for (const medlemskap of forhold.kontaktlarergruppemedlemskap) {
      ...
      elevforhold.kontaktlarergruppemedlemskap.push({
        ...
        periode: repackPeriode(gruppe.periode),
