import { feidenavnDomain, fint } from "../../../config.js"
...
const tfkExceptionRules = {
  ...
  nameChainOverride: {
    ...
    "O-39006-1B": {
      navn: "Fylkesdirektør",
      allowedNameChain: ["Fylkesdirektør", "Fylkesdirektør", "Fylkesdirektør", "Fylkesdirektør", "Fylkesdirektør avdeling"]
    },
    "O-39006-11": {
      navn: "Fylkesadvokatkontor",
      allowedNameChain: ["Fylkesadvokatkontor", "Fylkesadvokatkontor", "Fylkesadvokatkontor", "Fylkesadvokatkontor avdeling"]
    },
    "O-39006-1C": {
      navn: "Fylkeskommunale fellesutgifter",
      allowedNameChain: ["Fylkeskommunale fellesutgifter", "Fylkeskommunale fellesutgifter", "Fellesutgifter", "Fylkeskommunale fellesutgifter"]
    },
    "O-39006-1620": {
      navn: "Fagskolen elektrofag Horten",
      allowedNameChain: ["Fagskolen elektrofag Horten", "Fagskolen elektro"]
    },
    "O-39006-1621": {
      navn: "Fagskolen helse- og ledelsesfag Horten",
      allowedNameChain: ["Fagskolen helse- og ledelsesfag Horten", "Fagskolen helsefag"]
    },
    "O-39006-1622": {
      navn: "Fagskolen maritim utdanning Horten",
      allowedNameChain: ["Fagskolen maritim utdanning Horten", "Fagskolen maritim utdanning"]
    },
    "O-39006-3210": {
      navn: "Drift Telemarkshuset Skien",
      allowedNameChain: ["Drift Telemarkshuset Skien", "Drift administrasjonsbygg"]
    },
    "O-39006-41": {
      navn: "Videregående skoler",
      allowedNameChain: ["Videregående skoler", "VGS felles", "VGS felles"]
    },
    "O-39006-4151": {
      navn: "Hjalmar Johansen vgs - elevkantine",
      allowedNameChain: ["Hjalmar Johansen vgs - elevkantine", "Hjalmar Johansen vgs elevkantine"]
    },
    "O-39006-4152": {
      navn: "Hjalmar Johansen vgs - restaurant og matfag",
      allowedNameChain: ["Hjalmar Johansen vgs - restaurant og matfag", "Hjalmar Johansen vgs restaurant og matfag"]
    },
    "O-39006-4191": {
      navn: "Nome vgs - Søve elevkantine",
      allowedNameChain: ["Nome vgs - Søve elevkantine", "Nome vgs kantine Søve"]
    },
    "O-39006-4192": {
      navn: "Nome vgs - Lunde elevkantine",
      allowedNameChain: ["Nome vgs - Lunde elevkantine", "Nome vgs kantine Lunde"]
    },
    "O-39006-4193": {
      navn: "Nome vgs - bygg, anlegg + voksenopplæring",
      allowedNameChain: ["Nome vgs - bygg, anlegg + voksenopplæring", "Nome vgs bygg, anlegg og voksenopplæring"]
    },
    "O-39006-4194": {
      navn: "Nome vgs - Helse og oppvekst + fellesfag",
      allowedNameChain: ["Nome vgs - Helse og oppvekst + fellesfag", "Nome vgs helse og oppvekst og fellesfag"]
    },
    "O-39006-4195": {
      navn: "Nome vgs - Elektro, FBIE og TEK",
      allowedNameChain: ["Nome vgs - Elektro, FBIE og TEK", "Nome vgs elektro, FBIE og TEK"]
    },
    "O-39006-4199": {
      navn: "Nome vgs pedagogisk støtte og elevtjenester",
      allowedNameChain: ["Nome vgs pedagogisk støtte og elevtjenester", "Nome vgs elevtjenester"]
    },
    "O-39006-4211": {
      navn: "Notodden vgs - ressurssenter",
      allowedNameChain: ["Notodden vgs - ressurssenter", "Notodden vgs ressurssenter"]
    },
    "O-39006-4292": {
      navn: "Skogmo vgs - elektro",
      allowedNameChain: ["Skogmo vgs - elektro", "Skogmo vgs elektrofag"]
    },
    "O-39006-4293": {
      navn: "Skogmo vgs - bygg",
      allowedNameChain: ["Skogmo vgs - bygg", "Skogmo vgs bygg og anleggsfag"]
    },
    "O-39006-4294": {
      navn: "Skogmo vgs - TEK/Realfag",
      allowedNameChain: ["Skogmo vgs - TEK/Realfag", "Skogmo vgs TEK og realfag"]
    },
    "O-39006-4295": {
      navn: "Skogmo vgs - fellesfag",
      allowedNameChain: ["Skogmo vgs - fellesfag", "Skogmo vgs fellesfag"]
    },
    // OBS, kanskje sjekke denne?
    "O-39006-4296": {
      navn: "Skogmo vgs - pedagogisk støtte",
      allowedNameChain: ["Skogmo vgs - pedagogisk støtte", "Skogmo vgs tilrettelagt opplæring"]
    },
    "O-39006-4298": {
      navn: "Skogmo vgs - HO vg2-3",
      allowedNameChain: ["Skogmo vgs - HO vg2-3", "Skogmo vgs helse og oppvekst VG 2-3"]
    },
    "O-39006-4299": {
      navn: "Skogmo vgs - OIK",
      allowedNameChain: ["Skogmo vgs - OIK", "Skogmo vgs opplæring i kriminalomsorgen"]
    },
    "O-39006-4410": {
      navn: "Pedagogisk psykologisk tjeneste (PPT)",
      allowedNameChain: ["Pedagogisk psykologisk tjeneste (PPT)", "Pedagogisk psykologisk tjeneste"]
    },
    "O-39006-4420": {
      navn: "Oppfølgingstjenesten (OT)",
      allowedNameChain: ["Oppfølgingstjenesten (OT)", "Oppfølgingstjenesten"]
    },
    "O-39006-484": {
      navn: "Midt Telemark klinikk",
      allowedNameChain: ["Midt Telemark klinikk", "Midt-Telemark tannklinikk", "Midt-Telemark tannklinikk"]
    },
    "O-39006-5": {
      navn: "Samferdsel",
      allowedNameChain: ["Samferdsel", "Samferdsel", "Samferdsel", "Fylkessjef for Samferdsel", "Samferdsel"]
    },
    "O-39006-51": {
      navn: "Seksjon vegforvaltning og transport",
      allowedNameChain: ["Seksjon vegforvaltning og transport", "Vegforvaltning og transport", "Vegforvaltning og transport", "Vegforvaltning og transport"]
    },
    "O-39006-52": {
      navn: "Seksjon vegdrift",
      allowedNameChain: ["Seksjon vegdrift", "Vegdrift", "Vegdrift", "Vegdrift"]
    },
    "O-39006-5210": {
      navn: "Team driftskontrakter veg",
      allowedNameChain: ["Team driftskontrakter veg", "Driftskontrakt veg"]
    },
    "O-39006-5220": {
      // Har bare en underordnet inntil videre, så vi godtar den enn så lenge
      navn: "Team vedlikehold",
      allowedNameChain: ["Team vedlikehold", "Team teknisk vegdrift"]
    },
    "O-39006-53": {
      navn: "Seksjon vegutbygging",
      allowedNameChain: ["Seksjon vegutbygging", "Vegutbygging", "Driftsbudsjett - seksjonsleder Vegutbygging", "Vegutbygging"]
    },
    "O-39006-5310": {
      navn: "Driftsbudsjett - team Prosjektstøtte",
      allowedNameChain: ["Driftsbudsjett - team Prosjektstøtte", "Prosjektstøtte"]
    },
    "O-39006-5320": {
      navn: "Driftsbudsjett - team Plan og bygging",
      allowedNameChain: ["Driftsbudsjett - team Plan og bygging", "Plan og bygging"]
    },
    "O-39006-54": {
      navn: "Seksjon kollektiv",
      allowedNameChain: ["Seksjon kollektiv", "Kollektiv", "Kollektiv", "Kollektiv"]
    },
    "O-39006-5410": {
      navn: "Skoleskyss og drosjeløyver",
      allowedNameChain: ["Skoleskyss og drosjeløyver", "Skoleskyss, TT og løyver"]
    },
    "O-39006-6220": {
      navn: "Den kulturelle skolesekken (DKS)",
      allowedNameChain: ["Den kulturelle skolesekken (DKS)", "Den kulturelle skolesekken"]
    },
    "O-39006-6230": {
      navn: "Regional bibliotekutvikling",
      allowedNameChain: ["Regional bibliotekutvikling", "Bibliotek"]
    },
    "O-39006-6310": {
      navn: "Klima, miljø og internasjonalt arbeid",
      allowedNameChain: ["Klima, miljø og internasjonalt arbeid", "Klima, miljø og internasjonalt"]
    }
  },
  // Sier spesifikt hvilke underenheter som skal dunkes inn i parent, og dermed fjernes fra strukturen (parent overtar underenhetene)
  absorbChildrenOverrides: {
...
const getExceptionRules = () => {
  if (feidenavnDomain.includes("vestfoldfylke")) {
    return vfkExceptionRules
  }
  if (feidenavnDomain.includes("telemarkfylke")) {
    return tfkExceptionRules
  }

  return {
    // Return default rules for consistent return type
    overrideNextProbableLink: {},
    useAbstractAsUnitOverride: {},
    nameChainOverride: {},
    absorbChildrenOverrides: {},
