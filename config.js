...
export const graphUrl = process.env.GRAPH_URL ?? 'url til graph'
export const feidenavnDomain = process.env.FEIDENAVN_DOMAIN ?? '@domene.com'
export const studentUpnSuffix = process.env.STUDENT_UPN_SUFFIX ?? '@skole.fylke.no'
export const employeeNumberExtenstionAttribute = process.env.EMPLOYEE_NUMBER_EXTENSION_ATTRIBUTE ?? 'extensionAttributeX'
export const topUnitId = process.env.TOP_UNIT_ID ?? 'hoved'

export const organizationFixed = {
...
export const teamsStatusAlertUrls = (process.env.TEAMS_STATUS_ALERT_URLS && process.env.TEAMS_STATUS_ALERT_URLS.split(',')) || []
